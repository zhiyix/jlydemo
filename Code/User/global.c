...
const unsigned char RESET_ADJUST_CURVE1[100] =
 {0x0F,0x00,0x0A,0x00,0x00,0x00,0x00,0x00,    	//???? (wendu )??-40~100?
  0x00,0x95,0x00,0xd5,0x01,0x78,0x02,0x6c,
  0x03,0xb9,0x05,0x55,0x07,0x1b,0x08,0xdd,
  0x0a,0x73,0x0b,0xc6,0x0c,0xd4,0x0d,0xa0,
  0x0e,0x2e,0x0e,0xaa,0x0f,0x00,              	//AD????
  10,
  0x0A,0x0A,0x0A,0x0A,
  0x0A,0x0A,0x0A,0x0A,
  0x0A,0x0A,0x0A,0x0A,
...
const unsigned char RESET_ADJUST_CURVE2[100] =
 {0x0F,0x00,0x0A,0x00,0x00,0x00,0x00,0x00,	//???? (wendu )pt1000
  0x00,0x00,0x01,0x2E,0x02,0x58,0x03,0x80,
  0x04,0xA4,0x05,0xC6,0x06,0xE5,0x08,0x00,
  0x09,0x1A,0x0A,0x30,0x0B,0x43,0x0C,0x55,
  0x0D,0x63,0x0e,0x6E,0x0f,0x77,                //AD????
  3,
  0xa1,0xa2,0xa2,0xa2,
  0xa2,0xa3,0xa3,0xa3,
  0xa4,0xa4,0xa4,0xa5,
...
const unsigned char RESET_ADJUST_CURVE3[100] =
 {0x0F,0x00,0x0A,0x00,0x00,0x00,0x00,0x00,  	//???? (wendu )0--140du
  0x00,0x49,0x00,0x7B,0x00,0xCA,0x01,0x41,
  0x01,0xE9,0x02,0xCD,0x03,0xEb,0x05,0x3d,
  0x06,0xAF,0x08,0x27,0x09,0x87,0x0A,0xCC,
  0x0B,0xDD,0x0C,0xBE,0x0D,0x72,              	//AD????
  20,
  0x14,0x0d,0xd4,0x06,
  0xac,0xa3,0x03,0x9b,
  0x9b,0x9c,0x9f,0xa5,
...
const unsigned char RESET_ADJUST_CURVE4[100] =
 {0x0B,0x00,0x0A,0x00,0x00,0x00,0x00,0x00,	//????(??)1
  0x03,0x1f,0x04,0x5c,0x05,0x9a,0x06,0xd7,
  0x08,0x15,0x09,0x53,0x0a,0x90,0x0b,0xce,
  0x0d,0x0c,0x0e,0x49,0x0f,0x87,          	//AD????
...
const char RESET_CHANNEL_SETUP_TABLE[104] =
 {0x01,0x01,0x01,0x01,0x00,0x00,0x00,0x00,   //???????????????0-7??????
 	                                     //A0=0x01??  A3=0x02??
  ...
  0xa8,0x00,0xa8,0x00,0xa8,0x00,0xa8,0x00,  //?????????????? ?????value=low*(10?high??)
  ...
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  //boot
  0x01,0x0E,0x55,0x55,0xFC,C_VER_YEAR,C_VER_MONTH,C_VER_DAY,  //No.1??????,???0-7???????0-??7,
  };                                        //???????????????,?0x09????
                                            //0?3????,0x05????0?2????,0x01??  ?
                                           //??0??,????
                                           //0x9  0????  3????
