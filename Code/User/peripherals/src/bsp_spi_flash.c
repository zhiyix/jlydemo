...
/* 发送缓冲区初始化 */
uint8_t Tx_Buffer[] = "欢迎使用 32 BITS Discovery";
...
void SPI_FLASH_Init(void)
{
  ...
  RCC_AHBPeriphClockCmd(SPI_FLASH_SPI_SCK_GPIO_CLK | SPI_FLASH_SPI_MISO_GPIO_CLK |
                        SPI_FLASH_SPI_MOSI_GPIO_CLK | SPI_FLASH_CS_GPIO_CLK, ENABLE);
  ...
  //注意加上这三句
  /* Connect PXx to SPI_FLASH_SCK */
  GPIO_PinAFConfig(SPI_FLASH_SPI_SCK_GPIO_PORT,SPI_FLASH_SPI_SCK_SOURCE,SPI_FLASH_SPI_SCK_AF);          
  
  /* Connect PXx to SPI_FLASH_MISO */
  GPIO_PinAFConfig(SPI_FLASH_SPI_MISO_GPIO_PORT,SPI_FLASH_SPI_MISO_SOURCE,SPI_FLASH_SPI_MISO_AF);          
  
  /* Connect PXx to SPI_FLASH_MISO */
  GPIO_PinAFConfig(SPI_FLASH_SPI_MOSI_GPIO_PORT,SPI_FLASH_SPI_MOSI_SOURCE,SPI_FLASH_SPI_MOSI_AF);          

  /* Deselect the FLASH: Chip Select high */
  SPI_FLASH_CS_HIGH();

  /* SPI1 configuration */
  // W25Q64: data input on the DIO pin is sampled on the rising edge of the CLK. 
...
* Description    : Reads FLASH Jedec Device ID.
* Input          : None
* Output         : None
* Return         : FLASH Jedec Device ID
*******************************************************************************/
...
* Description    : Reads FLASH Device ID.
* Input          : None
* Output         : None
