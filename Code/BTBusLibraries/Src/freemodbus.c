...
//<!
__weak bool PARAM_DATA_READ(uint8_t *pucBuffer, USHORT usAddress, USHORT usNRegs)
{
	usAddress *= 2;
	usNRegs *= 2;
	return true;
...
//<! 
__weak bool PARAM_DATA_WRITE(uint8_t *pucBuffer, USHORT usAddress, USHORT usNRegs)
{
	usAddress *= 2;
	usNRegs *= 2;
	return true;
...
//<! 
__weak bool STORAGE_DATA_READ(uint8_t *pucBuffer, USHORT usAddress, USHORT usNRegs)
{
	usAddress *= 2;
	usNRegs *= 2;
	return true;
...
//<! 
__weak bool REALDATA_DATA_READ(uint8_t *pucBuffer, USHORT usAddress, USHORT usNRegs)
{
	usAddress *= 2;
	usNRegs *= 2;
	return true;
